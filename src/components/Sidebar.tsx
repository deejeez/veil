...
type IconName = 'home' | 'tasks' | 'vendors' | 'venue' | 'budget' | 'finances' | 'timeline' | 'settings'
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '0 10px', borderTop: '1px solid var(--color-border)', paddingTop: '16px' }}>
        <p style={{ fontFamily: 'var(--font-body)', fontSize: '10px', color: 'var(--color-text-secondary)', margin: 0, opacity: 0.6, letterSpacing: '0.05em' }}>
          Made with love
        </p>
      </div>
    </div>
